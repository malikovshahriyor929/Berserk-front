...
const summary = `The contractor missed a revision deadline, and shipment delays caused work to pause. The team approved the new scope, but inspections found issues like missing signs and material changes. Workers reported unsafe conditions, and one vendor's delivery was rejected. Progress is steady, but documentation is still pending.`;
