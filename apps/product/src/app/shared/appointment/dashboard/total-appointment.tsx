...
const data = [
  { label: 'Jan', booking: 6, visitors: 4 },
  { label: 'Feb', booking: 7, visitors: 5 },
  { label: 'Mar', booking: 5, visitors: 4 },
  { label: 'Apr', booking: 6, visitors: 5 },
  { label: 'May', booking: 7, visitors: 6 },
  { label: 'Jun', booking: 5, visitors: 5 },
  { label: 'Jul', booking: 6, visitors: 4 },
];
    ...
    >
      <div className="mb-4 mt-1 flex items-center gap-2">
        ...
        <span className="flex items-center gap-1 text-green-dark">
          ...
          <span className="font-semibold leading-none"> +12.00%</span>
        </span>
      </div>
