...
const data = [
  {
    id: 1,
    patient: 'Maftuna Tohirjonova',
    doctor: 'Dr. Javohir Sotvoldiyev',
    date: '2022-11-10T06:22:01.621Z',
  },
  {
    id: 2,
    patient: 'Zarina Xoliqova',
    doctor: 'Dr. Khojiakbar Abdulboriyev',
    date: '2022-11-10T06:22:01.621Z',
  },
  {
    id: 3,
    patient: 'Murodjon Xoliqboyev',
    doctor: 'Dr. Rahmatilla Erkinov',
    date: '2022-11-10T06:22:01.621Z',
  },
  {
    id: 4,
    patient: 'Abdurauf Qarshiboyev',
    doctor: 'Dr. Abdurauf Qarshiboyev',
    date: '2022-11-10T06:22:01.621Z',
  },
  {
    id: 5,
    patient: 'Shahzoda Qarshiboyeva',
    doctor: 'Dr. Jurabek Qarshiboyev',
    date: '2022-11-10T06:22:01.621Z',
  },
];
          ...
          <div className="relative before:absolute before:start-9 before:top-3 before:z-0 before:h-[calc(100%-24px)] before:w-1 before:translate-x-0.5 before:bg-gray-200">
            {data.map((item) => (
              <AdvancedCheckbox
                ...
                inputClassName="[&:checked~.rizzui-advanced-checkbox]:ring-muted [&:checked~.rizzui-advanced-checkbox>span>svg]:opacity-100 [&:checked~.rizzui-advanced-checkbox>span]:border-[#11886f] [&:checked~.rizzui-advanced-checkbox>div>div>strong]:line-through [&:checked~.rizzui-advanced-checkbox>div>div>strong]:text-gray-500 [&:checked~.rizzui-advanced-checkbox>div>div>strong+span]:line-through"
              ...
              >
                <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full border-2 border-primary">
                  <PiCheckBold className="fill-[#11886f] opacity-0" />
                </span>
                <div className="block">
                  <div className="text-gray-600">
                    ...
                    <span className="inline-block rounded-2xl bg-primary px-2.5 font-medium text-white">
                      {item.doctor}
                    </span>
                  </div>
