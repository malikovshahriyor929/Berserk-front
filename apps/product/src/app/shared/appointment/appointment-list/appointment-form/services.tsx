...
// Create appointmentTypesOptions from appointmentTypes object
...
// Define option type for proper TypeScript support
          ...
          render={({ field: { value, onChange } }) => (
            <Select
              ...
              displayValue={(selected) =>
                appointmentCategoryOptions?.find(
                  (p: OptionType) => p.value === selected
                )?.label ?? ''
              }
        ...
        <Controller
          ...
          render={({ field: { value, onChange } }) => (
            <Select
              ...
              error={errors?.service?.message as string} // Fixed: was showing category error message
            />
          )}
        />
      </div>
