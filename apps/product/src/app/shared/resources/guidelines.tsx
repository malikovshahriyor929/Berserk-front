...
import ProgramOverview from './guidelines-sections/program-overview';
import KeyGoals from './guidelines-sections/key-goals';
import RolesResponsibilities from './guidelines-sections/roles-responsibilities';
import MeetingFrequency from './guidelines-sections/meeting-frequency';
import CommunicationStandards from './guidelines-sections/communication-standards';
import EthicsPrivacy from './guidelines-sections/ethics-privacy';
import ImportantTimelines from './guidelines-sections/important-timelines';
          ...
          <span
            className={cn(
              ...
              isExpanded
                ...
                : 'bg-[#043764]/10 text-[#043764] dark:bg-gray-200/60 dark:text-blue-400'
            )}
          >
            {icon}
          </span>
  ...
  const guideSections = [
    {
      ...
      icon: <PiInfoBold className="h-5 w-5" />,
      component: <ProgramOverview />,
    },
    {
      id: 1,
      title: 'Key Goals of the Advising Program',
    ...
    {
      id: 3,
      title: 'Student Meeting Frequency',
      icon: <PiCalendarCheckBold className="h-5 w-5" />,
      component: <MeetingFrequency />,
    },
    {
      id: 4,
      title: 'Communication Standards',
      icon: <PiChatCenteredTextBold className="h-5 w-5" />,
      component: <CommunicationStandards />,
    },
    {
      id: 5,
      title: 'Ethics, Privacy & Confidentiality',
      icon: <PiShieldCheckBold className="h-5 w-5" />,
      component: <EthicsPrivacy />,
    },
    {
      id: 6,
      title: 'Important Timelines',
      icon: <PiClockBold className="h-5 w-5" />,
      component: <ImportantTimelines />,
    },
  ];
