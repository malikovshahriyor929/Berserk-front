      ...
      <div className="custom-scrollbar overflow-x-auto scroll-smooth -mb-3 mt-6 pb-3">
        <Box className="min-w-[900px] space-y-2">
          {activeTasksData.map((task, index) => (
            ...
            >
              <Box className="rounded-md bg-gray-100 dark:bg-gray-100 px-2 py-3 group-hover:bg-gray-200">
                <Text className="text-gray-600">{task.title}</Text>
              </Box>
              <Box className="grid grid-cols-12 gap-1 rounded-md bg-gray-50 group-hover:bg-green/10 dark:bg-gray-100">
                <Tooltip
                  placement="top"
                  className="p-0"
                ...
                >
                  <Flex
                    align="center"
                    justify="center"
                    className="h-full gap-0 rounded-md bg-green"
                    style={{
