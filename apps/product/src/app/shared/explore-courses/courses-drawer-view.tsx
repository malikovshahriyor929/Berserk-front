...
import {
  initialState,
  filterOptions,
} from '@/app/shared/explore-courses/courses-filter-utils';
import { CoursesFilterTags } from '@/app/shared/explore-courses/courses-filter-tags';
import DrawerHeader from '@/app/shared/drawer-header';
import { getOptionByValue } from '@core/utils/get-option-by-value';

export default function CoursesDrawerView() {
