          ...
          <Fragment key={item.name + '-' + index}>
            {item?.href ? (
                    ...
                    header={({ open, toggle }) => (
                      <div
                        ...
                        className={cn(
                          ...
                          isDropdownOpen
                            ? 'before:top-2/5 font-bold text-white before:absolute before:-start-3 before:block before:h-4/5 before:w-1.5 before:rounded-ee-md before:rounded-se-md before:bg-white dark:text-gray-700 dark:before:bg-gray-700 2xl:before:-start-5'
                            : 'text-gray-300/90 transition-colors duration-200 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-500 dark:hover:text-gray-700'
                        )}
                      >
                            ...
                            <span
                              className={cn(
                                ...
                                isDropdownOpen
                                  ...
                                  : 'text-gray-300/90 group-hover:text-gray-700 dark:text-gray-500 dark:group-hover:text-gray-600'
                              )}
                            >
                              {item?.icon}
                            </span>
                        ...
                        <PiCaretDownBold
                          strokeWidth={3}
                          className={cn(
                            'h-3.5 w-3.5 -rotate-90 text-gray-300/90 transition-transform duration-200 group-hover:text-gray-700 dark:text-gray-400 rtl:rotate-90',
                            open &&
              ...
              <Title
                as="h6"
                className={cn(
                  'mb-2 truncate px-6 text-xs font-normal uppercase tracking-widest text-gray-300/70 dark:text-gray-500 2xl:px-8',
