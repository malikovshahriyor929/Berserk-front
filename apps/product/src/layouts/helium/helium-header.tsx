...
function HeaderMenuRight() {
  return (
    <div className="text-mainBlue ms-auto grid shrink-0 grid-cols-5 items-center gap-2 dark:text-gray-700 xs:gap-3 xl:gap-4">
      <StyledThemeSwitch />

      <LanguageSwitcher
        iconClassName="hidden"
        selectClassName="shadow-none [&>span]:translate-y-0.5 [&>span]:translate-x-[1px]"
        className={cn(
          'relative h-[34px] w-[34px] overflow-hidden rounded-full shadow backdrop-blur-md dark:bg-gray-100 md:h-9 md:w-9 3xl:h-10 3xl:w-10'
        )}
      />
      <MessagesDropdown>
        <ActionIcon
...
export default function Header() {
  return (
    <header
      className={
        'sticky top-0 z-[990] flex items-center  bg-mainBlue-0/80 px-4 py-4 backdrop-blur-xl dark:bg-gray-50/50 md:px-5 lg:px-6 xl:-ms-1.5 xl:pl-4 2xl:-ms-0 2xl:py-5 2xl:pl-6 3xl:px-8 3xl:pl-6 4xl:px-10 4xl:pl-9'
      }
    >
